...
export function LrcMetadataEditor({ onClose }: { onClose?: () => void }) {
  ...
  const [customKeys, setCustomKeys] = useState<{ key: string; value: string }[]>(() => {
    ...
    const sysKeysList = ["kti", "kar", "kal", "ko", "tt", "tte", "kth", "klg", "klgno", "klgbm", "klgbmc", "kcr", "translationlrcenabled", "translationlrctext", "translationfontsize", "translationborderwidth", "translationspacing"];
