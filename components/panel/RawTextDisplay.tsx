...
const RawLine = React.memo(
  ({ idx, lineText, mappedOriginalIdx, activeLineIndex, paragraphStarts, linesLength }: any) => {
    const isHighlight = mappedOriginalIdx === activeLineIndex && linesLength > 0;
    const isParagraphStartColor =
      mappedOriginalIdx !== undefined &&
      paragraphStarts[mappedOriginalIdx] &&
      linesLength > 0 &&
      !isHighlight;
